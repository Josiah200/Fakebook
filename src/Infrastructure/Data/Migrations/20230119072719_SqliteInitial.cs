        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirthdateYearPublic = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "TEXT", nullable: false),
                    TimeStamp = table.Column<DateTime>(type: "TEXT", nullable: false),
                    FriendshipFriendId = table.Column<string>(type: "TEXT", nullable: true),
                    FriendshipUserId = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Messages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Messages_Friendships_FriendshipUserId_FriendshipFriendId",
                        columns: x => new { x.FriendshipUserId, x.FriendshipFriendId },
                        principalTable: "Friendships",
                        principalColumns: new[] { "UserId", "FriendId" });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    PhotoByteArray = table.Column<byte[]>(type: "BLOB", nullable: false),
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_FriendshipUserId_FriendshipFriendId",
                table: "Messages",
                columns: new[] { "FriendshipUserId", "FriendshipFriendId" });
